...
| --- | --- | --- |
| Web and retrieval | `WebSearch`, `ScholarSearch`, `DownloadPDF`, `WebFetch` | Search the web, search scholarly sources, download trusted PDFs into the workspace, and fetch webpage content for grounded tasks. |
